import { t as Route } from "./routes-MNu0fjKx.js";
import { useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { z } from "zod";
import { CalendarHeart, Church, Clock, Heart, MapPin, Moon, Music, PartyPopper, Shirt, UtensilsCrossed, Wine } from "lucide-react";
//#region src/assets/olive-branch.png
...
function Index() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [!opened && /* @__PURE__ */ jsx(EnvelopeGate, {
		guests: invitados,
		guestName: nombre,
		...
		children: [
			/* @__PURE__ */ jsx(Hero, {}),
			/* @__PURE__ */ jsx(CountdownSection, {}),
			/* @__PURE__ */ jsx(StorySection, {}),
			/* @__PURE__ */ jsx(LocationsSection, {}),
			/* @__PURE__ */ jsx(ItinerarySection, {}),
			/* @__PURE__ */ jsx(DressCodeSection, {}),
			/* @__PURE__ */ jsx(RSVPSection, {}),
			/* @__PURE__ */ jsx(Footer, {})
		]
	})] });
}
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "mx-auto my-5 h-px w-16 bg-primary/40" }),
						/* @__PURE__ */ jsxs("p", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-xl border border-primary/20 bg-secondary/70 shadow-sm" }),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", { className: "absolute -top-[60%] left-1/2 h-[120%] w-[80%] -translate-x-1/2 rotate-45 border-b border-primary/10 bg-secondary/80" })
						}),
						/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "mx-auto my-6 h-px w-16 bg-primary/40" }),
				/* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: FORBIDDEN_COLORS.map((color, index) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", { className: `h-full w-full ${color.className}` }), /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/2 h-px w-[130%] -translate-x-1/2 -translate-y-1/2 rotate-45 bg-destructive/80" })]
							}),
							/* @__PURE__ */ jsx("span", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", { className: "absolute left-1/2 top-1/2 h-[40rem] w-[40rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/5 blur-3xl" })
			}),
			/* @__PURE__ */ jsx("img", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", { className: "mx-auto my-8 h-px w-24 bg-primary/40 animate-draw-line" })
			}),
			/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", { className: "h-12 w-px bg-gradient-to-b from-primary/60 to-transparent" })
			})
		]
	});
}
function CountdownSection() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		}), mounted ? /* @__PURE__ */ jsx(Countdown, {
			target: WEDDING_DATE,
			visible: isVisible
		}) : /* @__PURE__ */ jsx(CountdownPlaceholder, { visible: isVisible })]
	});
}
function Countdown({ target, visible }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: units.map((unit) => /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: LOCATIONS.map((location, index) => /* @__PURE__ */ jsx(LocationCard, {
					location,
					index,
					visible: isVisible
				}, location.name))
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary" }), /* @__PURE__ */ jsx("span", { children: location.address })]
				}), /* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2",
					children: [/* @__PURE__ */ jsx(Clock, { className: "h-4 w-4 shrink-0 text-primary" }), /* @__PURE__ */ jsx("span", { children: location.time })]
				})]
			}),
			/* @__PURE__ */ jsxs("a", {
				...
				children: [/* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4" }), "Cómo llegar"]
			})
		]
	});
}
