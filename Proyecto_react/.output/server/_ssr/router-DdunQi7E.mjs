...
import { t as Route$1 } from "./routes-MNu0fjKx.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DdunQi7E.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-R7CfoL9_.css";
...
var Route = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "You're invited to celebrate our wedding day with us."
			},
			{
				name: "author",
				content: "Lovable"
